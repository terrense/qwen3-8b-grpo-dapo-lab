# INC-20260911-163058-EFFECTIVE_SIGNAL_LOW

**Level:** YELLOW
**Rule:** `effective_signal_low`
**Metric:** `effective_signal_fraction`
**Step:** 15
**Timestamp:** 2026-09-11T16:30:58

## Observed symptom

only 18.8% of groups carry gradient signal

Value at detection: `0.1875`

Heuristic threshold: `0.3`

## Detection rule

`effective_signal_low` — see [`docs/observability/incident_taxonomy.md`](../../../../docs/observability/incident_taxonomy.md)
