# INC-20260911-163058-ZERO_STD_GROUP_RATIO_ABOVE_HEURISTIC

**Level:** YELLOW
**Rule:** `zero_std_group_ratio_above_heuristic`
**Metric:** `zero_std_group_ratio`
**Step:** 15
**Timestamp:** 2026-09-11T16:30:58

## Observed symptom

zero_std_group_ratio=0.812 exceeds heuristic 0.7

Value at detection: `0.8125`

Heuristic threshold: `0.7`

## Detection rule

`zero_std_group_ratio_above_heuristic` — see [`docs/observability/incident_taxonomy.md`](../../../../docs/observability/incident_taxonomy.md)
...
- `metric_window.csv` — 15 updates around the event
